...
namespace Microsoft.Samples.Kinect.SkeletonBasics
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private PictureShot pictureShot;
        ...
        private void DrawBone(Skeleton skeleton, DrawingContext drawingContext, JointType jointType0, JointType jointType1)
        {
            ...
            Joint JointRightHand = skeleton.Joints[JointType.HandRight];
            Joint JointLeftHand = skeleton.Joints[JointType.HandLeft];
            ...
            // 右手の座標を与え描画する。
            DrawPaintImage.Source = drawPaint.DrawOrangeDot(SkeletonPointToScreen(JointRightHand.Position));
            // 左手の座標を与え描画する。
            DrawPaintImage.Source = drawPaint.DrawSkyBlueDot(SkeletonPointToScreen(JointLeftHand.Position));
